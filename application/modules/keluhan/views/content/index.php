...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Keluhan.Content.Delete');
$can_edit		= $this->auth->has_permission('Keluhan.Content.Edit');
     ...
     <th>Waktu Lapor</th>
			...
			<tbody>
				...
				<tr>
					...
					<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/keluhan/edit/' . $record->id_keluhan, '<span class="glyphicon glyphicon-edit"></span> ' .  $record->display_name." (".$record->username.")"); ?></td>
				<?php else : ?>
