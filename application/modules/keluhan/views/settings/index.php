...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Keluhan.Settings.Delete');
$can_edit		= $this->auth->has_permission('Keluhan.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/keluhan/edit/' . $record->id_keluhan, '<span class="icon-pencil"></span> ' .  $record->email_keluhan); ?></td>
				<?php else : ?>
