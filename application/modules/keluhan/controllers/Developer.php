...
{
    protected $permissionCreate = 'Keluhan.Developer.Create';
    protected $permissionDelete = 'Keluhan.Developer.Delete';
    protected $permissionEdit   = 'Keluhan.Developer.Edit';
    protected $permissionView   = 'Keluhan.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_keluhan()) {
                ...
                redirect(SITE_AREA . '/developer/keluhan');
            }
