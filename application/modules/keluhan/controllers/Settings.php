...
{
    protected $permissionCreate = 'Keluhan.Settings.Create';
    protected $permissionDelete = 'Keluhan.Settings.Delete';
    protected $permissionEdit   = 'Keluhan.Settings.Edit';
    protected $permissionView   = 'Keluhan.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_keluhan()) {
                ...
                redirect(SITE_AREA . '/settings/keluhan');
            }
