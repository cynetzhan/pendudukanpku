...
{
    protected $permissionCreate = 'Keluhan.Reports.Create';
    protected $permissionDelete = 'Keluhan.Reports.Delete';
    protected $permissionEdit   = 'Keluhan.Reports.Edit';
    protected $permissionView   = 'Keluhan.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_keluhan()) {
                ...
                redirect(SITE_AREA . '/reports/keluhan');
            }
