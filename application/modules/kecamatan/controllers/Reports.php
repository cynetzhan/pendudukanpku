...
{
    protected $permissionCreate = 'Kecamatan.Reports.Create';
    protected $permissionDelete = 'Kecamatan.Reports.Delete';
    protected $permissionEdit   = 'Kecamatan.Reports.Edit';
    protected $permissionView   = 'Kecamatan.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_kecamatan()) {
                ...
                redirect(SITE_AREA . '/reports/kecamatan');
            }
