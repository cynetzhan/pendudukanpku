...
{
    protected $permissionCreate = 'Kecamatan.Settings.Create';
    protected $permissionDelete = 'Kecamatan.Settings.Delete';
    protected $permissionEdit   = 'Kecamatan.Settings.Edit';
    protected $permissionView   = 'Kecamatan.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_kecamatan()) {
                ...
                redirect(SITE_AREA . '/settings/kecamatan');
            }
