...
$num_columns	= 1;
$can_delete	= $this->auth->has_permission('Kecamatan.Reports.Delete');
$can_edit		= $this->auth->has_permission('Kecamatan.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/kecamatan/edit/' . $record->id_kecamatan, '<span class="icon-pencil"></span> ' .  $record->nama_kecamatan); ?></td>
				<?php else : ?>
