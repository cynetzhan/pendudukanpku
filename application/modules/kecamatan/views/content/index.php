...
$num_columns	= 1;
$can_delete	= $this->auth->has_permission('Kecamatan.Content.Delete');
$can_edit		= $this->auth->has_permission('Kecamatan.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/kecamatan/edit/' . $record->id_kecamatan, '<span class="icon-pencil"></span> ' .  $record->nama_kecamatan); ?></td>
				<?php else : ?>
