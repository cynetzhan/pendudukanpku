...
{
    protected $permissionCreate = 'Sarana.Content.Create';
    protected $permissionDelete = 'Sarana.Content.Delete';
    protected $permissionEdit   = 'Sarana.Content.Edit';
    protected $permissionView   = 'Sarana.Content.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_sarana()) {
                ...
                redirect(SITE_AREA . '/content/sarana');
            }
