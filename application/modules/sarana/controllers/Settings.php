...
{
    protected $permissionCreate = 'Sarana.Settings.Create';
    protected $permissionDelete = 'Sarana.Settings.Delete';
    protected $permissionEdit   = 'Sarana.Settings.Edit';
    protected $permissionView   = 'Sarana.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_sarana()) {
                ...
                redirect(SITE_AREA . '/settings/sarana');
            }
