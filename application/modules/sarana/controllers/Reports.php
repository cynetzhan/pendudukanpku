...
{
    protected $permissionCreate = 'Sarana.Reports.Create';
    protected $permissionDelete = 'Sarana.Reports.Delete';
    protected $permissionEdit   = 'Sarana.Reports.Edit';
    protected $permissionView   = 'Sarana.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_sarana()) {
                ...
                redirect(SITE_AREA . '/reports/sarana');
            }
