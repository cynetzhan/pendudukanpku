...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Sarana.Settings.Delete');
$can_edit		= $this->auth->has_permission('Sarana.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/sarana/edit/' . $record->id_sarana, '<span class="icon-pencil"></span> ' .  $record->id_kecamatan); ?></td>
				<?php else : ?>
