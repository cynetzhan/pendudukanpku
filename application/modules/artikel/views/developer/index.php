...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Artikel.Developer.Delete');
$can_edit		= $this->auth->has_permission('Artikel.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/artikel/edit/' . $record->id_artikel, '<span class="icon-pencil"></span> ' .  $record->judul_artikel); ?></td>
				<?php else : ?>
