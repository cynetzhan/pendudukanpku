...
{
    protected $permissionCreate = 'Artikel.Reports.Create';
    protected $permissionDelete = 'Artikel.Reports.Delete';
    protected $permissionEdit   = 'Artikel.Reports.Edit';
    protected $permissionView   = 'Artikel.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_artikel()) {
                ...
                redirect(SITE_AREA . '/reports/artikel');
            }
