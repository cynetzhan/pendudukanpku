...
{
    protected $permissionCreate = 'Artikel.Settings.Create';
    protected $permissionDelete = 'Artikel.Settings.Delete';
    protected $permissionEdit   = 'Artikel.Settings.Edit';
    protected $permissionView   = 'Artikel.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_artikel()) {
                ...
                redirect(SITE_AREA . '/settings/artikel');
            }
